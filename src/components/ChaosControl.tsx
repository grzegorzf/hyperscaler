...
export const ChaosControl: React.FC<ChaosControlProps> = ({
  ...
  return (
    <div className="glass-panel rounded-xl px-4 py-3 border border-rose-500/30 text-xs font-mono">
      <button
        onClick={() => onChaosToggle(!chaosActive)}
        className={`w-full py-2 px-3 rounded-lg font-bold text-[10px] tracking-wider uppercase flex items-center justify-center gap-2 border transition-all ${
          chaosActive
