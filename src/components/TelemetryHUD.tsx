...
export const TelemetryHUD: React.FC<TelemetryHUDProps> = ({ state, history, className = "" }) => {
  ...
  return (
    <div
      ...
      className={`glass-panel gpu-spotlight cyber-hud-notch rounded-xl p-4 md:px-5 md:py-4 border border-cyan-500/30 grid grid-cols-2 sm:grid-cols-3 md:flex md:items-center gap-4 md:gap-6 text-xs font-mono pointer-events-auto ${className}`}
    >
      {/* 1. Region Latency */}
